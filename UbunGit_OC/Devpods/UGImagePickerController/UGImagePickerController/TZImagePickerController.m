...
- (void)addSelectedModel:(TZAssetModel *)model {
    NSMutableSet *modelSet = [NSMutableSet setWithArray:_selectedModels];
    [modelSet addObject:model];
    _selectedModels =[NSMutableArray arrayWithArray:[modelSet allObjects]];
    
    NSMutableSet *assetIdSet = [NSMutableSet setWithArray:_selectedAssetIds];
    [assetIdSet addObject:model.asset.localIdentifier];
    _selectedAssetIds = [NSMutableArray arrayWithArray: [assetIdSet allObjects]];
